...
-- NOTE: no CREATE DATABASE / USE statements here on purpose — InfinityFree
-- (and most shared hosts) only let you use the ONE database they already
-- created for you, selected in phpMyAdmin before you click Import.
